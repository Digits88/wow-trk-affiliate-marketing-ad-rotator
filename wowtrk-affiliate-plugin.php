...
class wowtrk_affiliate{
	...
	function wowtrk_options(){
		...
		echo '
<a href="https://www.wowtrk.com/login" target="_blank"><img src="' . get_bloginfo('wpurl') . '/wp-content/plugins/wow-trk-affiliate-marketing-ad-rotator/images/wt-logo-new.png" alt="WOW Trk - Logo"></a>
<h2>WOW Trk - Plugin Settings</h2>';
		if($updated)
...
<a href="https://www.wowtrk.com/login" target="_blank">Login</a> to your account and go to My Account -> Account Details, on the account details page under Company Details you will find your ID.
		...
		<tr><th scope="row">HTTPS</th>
			<td>
				...
				echo'</select><BR>
        Enable this to serve ads over HTTPS instead of HTTP. If you are unsure on what this does, leave "No" selected.
			</td>
		</tr>
